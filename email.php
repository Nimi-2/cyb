...
class M
{
 public function send_email($address,$content){
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = '8b020da9f5cb48'; // Podaj swój login z Mailtrap
            $mail->Password = '5ef04e1b08d930'; // Podaj swoje hasło z Mailtrap
            $mail->SMTPSecure = 'tls';
            $mail->Port = 2525;

            // Nadawca i odbiorca
            $mail->setFrom('nadawca@example.com', 'Nadawca');
            $mail->addAddress('odbiorca@example.com', 'Odbiorca');
